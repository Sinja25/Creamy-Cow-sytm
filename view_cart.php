...
if (!isset($_POST['checkout']) && !isset($_POST['confirmed'])) {
	...
	if ($checker == 1) {
		...
		echo '<a href="index.php" class="btn btn-primary" style="margin-right:2%;position:absolute; right:250px;"><span class="glyphicon glyphicon-arrow-left"></span>Back</a>';
		echo '<button type="submit" name="checkout" class="btn btn-success" style="
		position:absolute; right:0;"><span class="glyphicon glyphicon-check"></span>Checkout</button> </form>';
		...
		<center>
			...
			<div class="d-flex justify-content-center">
				<div class="card border-primary">
					<img src="./resources/images/gcashqrcode.jpg" width="150px" height="150px" alt="">
				</div>
			</div>
		</center>
